...
type Chain struct {
	...
	Node string `long:"node" description:"The blockchain interface to use." choice:"ltcd" choice:"litecoind" choice:"doriancoind" choice:"neutrino" choice:"nochainbackend"`
